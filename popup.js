...
setTimeout(function() {
  ...
  fetch(api + "password", {
    ...
    .then(res => {
      ...
      // else
      // document.getElementById("test1i").src = "./images/poker.png"
  ...
  fetch(api + "data_expose", {
    ...
    .then(res => {
      ...
      // else
      // document.getElementById("test2i").src = "./images/poker.png"
...
//     if(data.vulnerable)
//     document.getElementById("test"+i+"i").src = "./images/hand.svg"
//     else   document.getElementById("test"+i+"i").src = "./images/green.svg"
